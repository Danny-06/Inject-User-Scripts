import stylesheet from '../stylesheets/main.css' assert {type: 'css'}

if (!location.pathname.startsWith('/api/') && !location.pathname.startsWith('/user/')) {
...
fullscreenButton.addEventListener('mouseup', event => {
